...
public class analyzeMids : MonoBehaviour
{
    public AudioSource actualPlayer;
    ...
    public delegate void OnMidsPeak();
    public static event OnMidsPeak MidsPeak;
    ...
    public void analyzeSpectrum()
    {
        ...
        if (spectralFluxSamples.Count >= thresholdWindowSize)
        {
            ...
            if (!actualPlayer.isPlaying) { actualPlayer.Play(); }
