...
public class analyzeHighs : MonoBehaviour
{
    ...
    public delegate void OnHighPeak();
    public static event OnHighPeak HighPeak;
    ...
    public void analyzeSpectrum()
    {
        ...
        float[] highs = new float[6];


        System.Array.Copy(spectrumGenerator.getCurSpectrum(), 12, highs, 0, 6);


        // Set spectrum
        setCurSpectrum(highs);
